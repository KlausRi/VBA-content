    ...
    With m_rnCheck
        ...
        If Not m_rnFind Is Nothing Then
            ...
            Do
                ...
                if Not m_rnFind Is Nothing then exit do
                'reading the adress property when the range object is nothing will cause an error
                'so first you need to check whether the range is nothing and then you can refer to the adress
                'just like you did in the first code example
            Loop while m_rnFind.Address <> m_stAddress
        End If
    End With
